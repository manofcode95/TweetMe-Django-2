...
from .views import TweetListAPIView, TweetCreateAPIView, RetweetAPIView, TweetRetrieveAPIView, LikeAPIView, TweetSearchAPIView
app_name='tweets_api'
...
urlpatterns = [
    ...
    url(r'^search/$', TweetSearchAPIView.as_view(), name='search_api'),
